  ...
  <div class="user-admin">
      ...
      <b-row v-show="mode === 'save'">
        ...
        <b-col md="6" sm="12">
          <b-form-group label="Confirmação de Senha:" label-for="user.confirmPassword">
            <b-form-input id="user.confirmPassword" type="password" v-model="user.confirmPassword" required placeholder="Confirme a senha do Usuário..."></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
      <b-row>
    ...
    <b-table hover striped :items="users" :fields="fields">
      <template slot="actions" slot-scope="data">
        ...
        <b-button variant="danger" class="mb-1" @click="loadUser(data.item, 'remove')">
